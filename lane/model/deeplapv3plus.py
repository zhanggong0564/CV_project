...
from model.resnet import resnet50_atrous
...
class DeeplabV3Plus(nn.Module):
    def __init__(self,cfg):
        ...
        input_channel= 2048
        self.aspp = ASPP(in_ch=input_channel,out_ch=cfg.ASPP_OUTDIM,rate=16//cfg.OUTPUT_STRIDE)
        self.dropout1 = nn.Dropout(0.5)
        self.upsample4 = nn.UpsamplingBilinear2d(scale_factor=4)
        self.upsample_sub = nn.UpsamplingBilinear2d(scale_factor=cfg.OUTPUT_STRIDE // 4)

        indim = 256
        self.shorcut_conv = nn.Sequential(
    ...
    def forward(self, x):
        ...
        feature_shallow = self.shorcut_conv(layers[0])
